...
final class MeasureTemplateExporter
{
    ...
    private function buildSections(array $catalog): array
    {
        ...
        return [
            ...
            $this->scalarSection('description', MeasureTemplateSchema::headers()['description'], 'M', 42),
            $this->scalarSection('implementation', MeasureTemplateSchema::headers()['implementation'], 'N', 42),
            $this->scalarSection('department_action_text', MeasureTemplateSchema::headers()['department_action_text'], 'O', 42),
            $this->matrixSection('impact_areas', MeasureTemplateSchema::matrixGroupLabels()['impact_areas'], $impactAreas, 'O', 14),
            ...
            $this->scalarSection('description_en', MeasureTemplateSchema::headers()['description_en'], 'S', 42),
            $this->scalarSection('implementation_en', MeasureTemplateSchema::headers()['implementation_en'], 'T', 42),
            $this->scalarSection('verification_sources_en', MeasureTemplateSchema::headers()['verification_sources_en'], 'U', 42),
            $this->scalarSection('department_action_text_en', MeasureTemplateSchema::headers()['department_action_text_en'], 'V', 42),
        ];
    }
