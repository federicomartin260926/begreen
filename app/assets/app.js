...
import EnergyV1FormController from './controllers/energy_v1_form_controller';
import WaterV1FormController from './controllers/water_v1_form_controller';
import AccommodationV1FormController from './controllers/accommodation_v1_form_controller';
import CateringV1FormController from './controllers/catering_v1_form_controller';
import WasteV1FormController from './controllers/waste_v1_form_controller';
import MaterialV1FormController from './controllers/material_v1_form_controller';
import TransportV20FormController from './controllers/transport_v20_form_controller';
import WoodFormController from './controllers/wood_form_controller';
...
application.register('energy-v1-form', EnergyV1FormController);
application.register('water-v1-form', WaterV1FormController);
application.register('accommodation-v1-form', AccommodationV1FormController);
application.register('catering-v1-form', CateringV1FormController);
application.register('waste-v1-form', WasteV1FormController);
application.register('material-v1-form', MaterialV1FormController);
application.register('transport-v20-form', TransportV20FormController);
application.register('wood-form', WoodFormController);
